      ...
      root: ({ theme }) => ({
        ...
        variants: [
          ...
          },
          {
            ...
            style: {
              color: 'white',
              backgroundImage: `linear-gradient(to bottom, ${brand[700]}, ${brand[900]})`,
              boxShadow: `none`,
              border: `1px solid ${brand[700]}`,
              '&:hover': {
                backgroundImage: `linear-gradient(to bottom, ${brand[600]}, ${brand[800]})`,
              ...
              ...theme.applyStyles('dark', {
                ...
                backgroundImage: `linear-gradient(to bottom, ${brand[50]}, ${brand[25]})`,
                boxShadow: 'none',
          ...
          },
          {
            ...
            style: {
              ...
              ...theme.applyStyles('dark', {
                ...
                '&:active': {
                  backgroundColor: alpha(brand[900], 0.7),
                },
              }),
            },
          },
  ...
  MuiCheckbox: {
    ...
    styleOverrides: {
      root: ({ theme }) => ({
        ...
        ...theme.applyStyles('dark', {
          borderColor: alpha(brand[900], 0.8),
          boxShadow: '0 0 0 1.5px hsl(210, 0%, 0%) inset',
          backgroundColor: alpha(brand[975], 0.8),
          '&:hover': {
            borderColor: brand[300],
          },
          '&.Mui-focusVisible': {
